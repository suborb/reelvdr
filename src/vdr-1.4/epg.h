...
public:
  ...
  cComponents *Components(void) const { return components; }
...
// MQ
  static cCleanSchedulesThread *CleanSchedulesThread;
public:
...
class cCleanSchedulesThread : public cThread {
private:
...
cCleanSchedulesThread(cSchedules *xschedules, const char *xepgDataFileName, time_t *xlastCleanup, time_t *xlastDump,time_t *xmodified);
cCondWait wTerm;
