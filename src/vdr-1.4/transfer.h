...
public:
  cTransfer(int VPid, int PPid, const int *APids, const int *DPids, const int *SPids);
  virtual ~cTransfer();
  };
...
public:
  cTransferControl(cDevice *ReceiverDevice, int VPid, int PPid, const int *APids, const int *DPids, const int *SPids);
  ~cTransferControl();
