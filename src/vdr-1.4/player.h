...
protected:
  ...
  int DeviceAproxFramesInQueue(void) { return device?device->AproxFramesInQueue():0; }
...
public:
  ...
  // start by Balaji
  virtual bool   CanHandleSubtitles()           { return false; }
  virtual int    GetCurrentSubtitleTrack()      { return 0;     }
  virtual int    NumSubtitleTracks()            { return 0;     }
  virtual const char*  SubtitleTrackName(int i)       { return "";    }
  virtual bool   SetCurrentSubtitleTrack(int i) { return false; } 
  // end by Balaji
  };
