...
void cSdtFilter::Process(u_short Pid, u_char Tid, const u_char *Data, int Length)
{
  ...
  for (SI::Loop::Iterator it; sdt.serviceLoop.getNext(SiSdtService, it); ) {
      ...
      if(channel && channel->GetRefChannel()) // Skip linked channels (will be handled in eit)
         continue;
            ...
            case SI::ServiceDescriptorTag: {
                 ...
                 switch (sd->getServiceType()) {
                   ...
                   case 0xC3: // some french channels like kiosk
                        ...
                        sd->serviceName.getText(NameBuf, ShortNameBuf, sizeof(NameBuf), sizeof(ShortNameBuf), charset);
                        ...
                        sd->providerName.getText(ProviderNameBuf, sizeof(ProviderNameBuf), charset);
