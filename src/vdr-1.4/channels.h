...
#include <vector>	// for noEPGChannels list
...
public:
  ...
  void AddToBouquet(cChannel* NewChannel, cChannel* c_bouquet); // added by Balaji

  bool SyncNoEPGChannels(const char *FileName);
  bool isEPGAllowed(tChannelID ChannelID);
  };
