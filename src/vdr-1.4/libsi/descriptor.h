...
public:
   ...
   char *getText(char *buffer, int size, const char *charset, const char *separation1="\t", const char *separation2="\n");

   //these only return the non-itemized text fields in concatenated form
   int getMaximumTextPlainLength();
   char *getTextPlain(const char *charset);
   char *getTextPlain(char *buffer, int size, const char *charset);
   ...
   char *getTextItemized(char *buffer, int size, const char *charset, const char *separation1="\t", const char *separation2="\n");
   ...
   bool getTextItemized(Loop::Iterator &it, bool &valid, char *itemDescription, char *itemText, int sizeItemDescription, int sizeItemText, const char *charset);
};
