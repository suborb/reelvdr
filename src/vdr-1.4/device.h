...
public:
  ...
  virtual bool HasInput(void) const;
         ///< Tells whether the device delivers input, e.g. the device got some dvb-tuner
...
public:
  ...
  bool SwitchChannel(const cChannel *Channel, bool LiveView, bool WithCI);
...
public:
  eSetChannelResult SetChannel(const cChannel *Channel, bool LiveView, bool WithCI);
...
int PlayerGetCurrentSubtitleTrack();

int PlayerNumSubtitleTracks();
const char* PlayerSubtitleTrackName(int);

bool PlayerSetCurrentSubtitleTrack(int);
