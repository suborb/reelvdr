...
public:
     ...
     * @return 
     */
    std::vector<std::string> Albums(const std::string& genre, 
                                    const std::string& artist, 
                                    const std::string& album);
     ...
     * @return 
     */
    std::vector<std::string> Artists(const std::string& genre, const std::string& artist);
     ...
     * @return 
     */
    std::vector<std::string> Genres(const std::string& genre);
};
