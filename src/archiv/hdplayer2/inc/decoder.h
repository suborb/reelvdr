...
enum {
	...
	FORMAT_VC1 = FORMAT_TYPE_VIDEO + 0x8081,
...
int decypher_get_audio_device_index(struct decypher *dec);
...
int decypher_set_downmix_mode(struct decypher *dec, int downmix_mode);
int decypher_set_out_samplerate(struct decypher *dec, int out_samplerate);
