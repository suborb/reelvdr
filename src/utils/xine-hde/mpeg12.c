		...
		switch(start_code) {
			...
			case SEQ_START_CODE:
				...
				//TODO: set mpeg1 aspect
					...
					pc->frame_rate.num = avctx->time_base.num = ff_frame_rate_tab[frame_rate_index].den; // how in ffmpeg num = den
					pc->frame_rate.den = avctx->time_base.den = ff_frame_rate_tab[frame_rate_index].num; // how in ffmpeg den = num
