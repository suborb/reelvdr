...
#define FEC_9_10 (FEC_AUTO+2)

#define PSK_8    (VSB_16+1)
#define APSK_16  (VSB_16+2)
#define APSK_32  (VSB_16+3)
#define DQPSK    (VSB_16+4)

#define ROLLOFF_35   FE_ROLLOFF_35			
#define ROLLOFF_25   FE_ROLLOFF_25			
#define ROLLOFF_20   FE_ROLLOFF_20
#define ROLLOFF_AUTO FE_ROLLOFF_UNKNOWN

#define FE_CAN_2G_MODULATION 0x10000000

#define TRANSMISSION_MODE_4K TRANSMISSION_MODE_AUTO + 1
#define TRANSMISSION_MODE_1K TRANSMISSION_MODE_4K + 1
#define TRANSMISSION_MODE_16K TRANSMISSION_MODE_4K + 2
#define TRANSMISSION_MODE_32K TRANSMISSION_MODE_4K + 3
#define TRANSMISSION_MODE_C1  TRANSMISSION_MODE_4K + 4
#define TRANSMISSION_MODE_C3780 TRANSMISSION_MODE_4K + 5


#define GUARD_INTERVAL_1_128 GUARD_INTERVAL_AUTO + 1
#define GUARD_INTERVAL_19_128 GUARD_INTERVAL_AUTO + 2
#define GUARD_INTERVAL_19_256 GUARD_INTERVAL_AUTO + 3
...
#ifdef USE_MCLI
//  virtual int ReadFilter(int Handle, void *Buffer, size_t Length) { return cDevice::ReadFilter(Handle, Buffer, Length); }
