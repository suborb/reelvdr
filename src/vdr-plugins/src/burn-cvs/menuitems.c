...
namespace menu
{
	...
	recording_text_item::recording_text_item( const recording_list::iterator recording_ ):
			text_item( std::string("\x87 ") + recording_->m_title, true), // a tick mark with title
			m_recording( recording_ )
	{
	}
