/* 
 * status.c: 'ReelNG' skin for the Video Disk Recorder
 *
...
cReelStatus ReelStatus;

cReelStatus::cReelStatus(void) : mReplayMode(replayNone),
                                     mReplayIsLoop(false),
                                     mReplayIsShuffle(false)
{}

void cReelStatus::Replaying(const cControl * /*Control */ , const char *Name,
                              const char *FileName, bool On)
{
  debug("cReelStatus::Replaying(%s)", Name);
...
/*
void cReelStatus::Recording(const cDevice * Device, const char *Name, const char *FileName, bool On)
{
}
*/

void cReelStatus::OsdClear(void)
{
}

void cReelStatus::OsdCurrentItem(const char *Text)
{
}

void cReelStatus::OsdItem(const char *Text, int Index)
{
}

void cReelStatus::UpdateActiveTimers(void)
{
  mTimers.Clear();
