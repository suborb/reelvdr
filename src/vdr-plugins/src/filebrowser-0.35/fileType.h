...
class cFileType : public cDirEntryType
{
public:
...
public:
    ...
    virtual eOSState Update(cPlayListItem &item, cMenuFileBrowserBase *menu, bool currentChanched) const;
...
public:
    ...
    /*override*/ eOSState Open(cPlayListItem &item, cMenuFileBrowserBase *menu, bool asPlaylist = false) const;
    /*override*/ eOSState Update(cPlayListItem &item, cMenuFileBrowserBase *menu, bool currentChanched) const;
};
