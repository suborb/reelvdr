...
class cMenuBrowserBlockedIf : public cMenuBrowserBaseIf
{
    ...
    protected:
    cMenuBrowserBlockedIf(){}
    virtual void SetStartMessage(){};
    virtual void SetEndMessage(int ret){};
...
class cMenuBrowserInstallPacketIf : public cMenuBrowserBlockedIf
{
    public:
    static cMenuBrowserInstallPacketIf *Instance(){return &instance;}

    protected:
    cMenuBrowserInstallPacketIf(){}
    /*override*/ void SetStartMessage();
    /*override*/ void SetEndMessage(int ret);

    private:
    static cMenuBrowserInstallPacketIf instance;
};
...
class cMenuBrowserCmdOptionsIf : public cMenuBrowserOptionsIf
{
    ...
    eOSState SortFiles(cMenuFileBrowser *menu, sortMode mode);
