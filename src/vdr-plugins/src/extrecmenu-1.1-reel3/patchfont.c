 ...
 for(num_char=33, i = 1; num_char<256; i++, num_char++)
 {
  ...
  else if(num_char==133)
  {
   if(DvbFont==fontOsd)
   {
    font_data[i*num_rows+ 0]=22;
    font_data[i*num_rows+ 1]=27;
    font_data[i*num_rows+ 6]=0x200004; // #. .... .... .... .... .#..
    font_data[i*num_rows+ 7]=0x100008; // .# .... .... .... .... #...
    font_data[i*num_rows+ 8]=0x080010; // .. #... .... .... ...# ....
    font_data[i*num_rows+ 9]=0x0c0030; // .. ##.. .... .... ..## ....
    font_data[i*num_rows+10]=0x060060; // .. .##. .... .... .##. ....
    font_data[i*num_rows+11]=0x0300c0; // .. ..## .... .... ##.. ....
    font_data[i*num_rows+12]=0x018180; // .. ...# #... ...# #... ....
    font_data[i*num_rows+13]=0x00c300; // .. .... ##.. ..## .... ....
    font_data[i*num_rows+14]=0x006600; // .. .... .##. .##. .... ....
    font_data[i*num_rows+15]=0x003c00; // .. .... ..## ##.. .... ....
    font_data[i*num_rows+16]=0x001800; // .. .... ...# #... .... ....
    font_data[i*num_rows+17]=0x003c00; // .. .... ..## ##.. .... ....
    font_data[i*num_rows+18]=0x006600; // .. .... .##. .##. .... ....
    font_data[i*num_rows+19]=0x00c300; // .. .... ##.. ..## .... ....
    font_data[i*num_rows+20]=0x018180; // .. ...# #... ...# #... ....
    font_data[i*num_rows+21]=0x0c8130; // .. ##.. #... ...# ..## ....
    font_data[i*num_rows+22]=0x104208; // .# .... .#.. ..#. .... #...
    font_data[i*num_rows+23]=0x202404; // #. .... ..#. .#.. .... .#..
    font_data[i*num_rows+24]=0x104208; // .# .... .#.. ..#. .... #...
    font_data[i*num_rows+25]=0x0f81e0; // .. #### #... ...# ###. ....
   }
   else
   {
    font_data[i*num_rows+ 0]=22;
    font_data[i*num_rows+ 1]=22;
    font_data[i*num_rows+ 3]=0x200004; // #. .... .... .... .... .#..
    font_data[i*num_rows+ 4]=0x100008; // .# .... .... .... .... #...
    font_data[i*num_rows+ 5]=0x080010; // .. #... .... .... ...# ....
    font_data[i*num_rows+ 6]=0x0c0030; // .. ##.. .... .... ..## ....
    font_data[i*num_rows+ 7]=0x060060; // .. .##. .... .... .##. ....
    font_data[i*num_rows+ 8]=0x0300c0; // .. ..## .... .... ##.. ....
    font_data[i*num_rows+ 9]=0x018180; // .. ...# #... ...# #... ....
    font_data[i*num_rows+10]=0x00c300; // .. .... ##.. ..## .... ....
    font_data[i*num_rows+11]=0x006600; // .. .... .##. .##. .... ....
    font_data[i*num_rows+12]=0x003c00; // .. .... ..## ##.. .... ....
    font_data[i*num_rows+13]=0x001800; // .. .... ...# #... .... ....
    font_data[i*num_rows+14]=0x003c00; // .. .... ..## ##.. .... ....
    font_data[i*num_rows+15]=0x006600; // .. .... .##. .##. .... ....
    font_data[i*num_rows+16]=0x00c300; // .. .... ##.. ..## .... ....
    font_data[i*num_rows+17]=0x018180; // .. ...# #... ...# #... ....
    font_data[i*num_rows+18]=0x0c8130; // .. ##.. #... ...# ..## ....
    font_data[i*num_rows+19]=0x104208; // .# .... .#.. ..#. .... #...
    font_data[i*num_rows+20]=0x202404; // #. .... ..#. .#.. .... .#..
    font_data[i*num_rows+21]=0x104208; // .# .... .#.. ..#. .... #...
    font_data[i*num_rows+22]=0x0f81e0; // .. #### #... ...# ###. ....
   }
  }
  ...
  else if(num_char==134)
  {
   if(DvbFont==fontOsd)
   {
    font_data[i*num_rows+ 0]=22;
    font_data[i*num_rows+ 1]=27;       // .. .... .... .... ....
    font_data[i*num_rows+ 6]=0x018300; // .. ...# #... ..## ....
    font_data[i*num_rows+ 7]=0x018300; // .. ...# #... ..## ....
    font_data[i*num_rows+ 8]=0x030600; // .. ..## .... .##. ....
    font_data[i*num_rows+ 9]=0x030600; // .. ..## .... .##. ....
    font_data[i*num_rows+10]=0x060c00; // .. .##. .... ##.. ....
    font_data[i*num_rows+11]=0x07fc00; // .. .### #### ##.. ....
    font_data[i*num_rows+12]=0x0ff800; // .. #### #### #... ....
    font_data[i*num_rows+13]=0x0c1800; // .. ##.. ...# #... ....
    font_data[i*num_rows+14]=0x19f000; // .# #..# #### .... ....
    font_data[i*num_rows+15]=0x19fc00; // .# #..# #### ##.. ....
    font_data[i*num_rows+16]=0x336c00; // ## ..## .##. ##.. ....
    font_data[i*num_rows+17]=0x336400; // ## ..## .##. .#.. ....
    font_data[i*num_rows+18]=0x060c00; // .. .##. .... ##.. ....
    font_data[i*num_rows+19]=0x060c00; // .. .##. .... ##.. ....
    font_data[i*num_rows+20]=0x0c1800; // .. ##.. ...# #... ....
    font_data[i*num_rows+21]=0x0c1800; // .. ##.. ...# #... ....
    font_data[i*num_rows+22]=0x183000; // .# #... ..## .... ....
    font_data[i*num_rows+23]=0x187000; // .# #... .### .... ....
    font_data[i*num_rows+24]=0x3fe000; // ## #### ###. .... ....
    font_data[i*num_rows+25]=0x3fc000; // ## #### ##.. .... ....
   }
   else
   {
    font_data[i*num_rows+ 0]=22;
    font_data[i*num_rows+ 1]=22;
    font_data[i*num_rows+ 3]=0x018300; // .. ...##.....##....
    font_data[i*num_rows+ 4]=0x018300; // .. ...##.....##....
    font_data[i*num_rows+ 5]=0x030600; // .. ..##.....##.....
    font_data[i*num_rows+ 6]=0x030600; // .. ..##.....##.....
    font_data[i*num_rows+ 7]=0x060c00; // .. .##.....##......
    font_data[i*num_rows+ 8]=0x07fc00; // .. .#########......
    font_data[i*num_rows+ 9]=0x0ff800; // .. #########.......
    font_data[i*num_rows+10]=0x0c1800; // .. ##.....##.......
    font_data[i*num_rows+11]=0x19f000; // .# #..#####........
    font_data[i*num_rows+12]=0x19fc00; // .# #..#######......
    font_data[i*num_rows+13]=0x336c00; // ## ..##.##.##......
    font_data[i*num_rows+14]=0x336400; // ## ..##.##..#......
    font_data[i*num_rows+15]=0x060c00; // .. .##.....##......
    font_data[i*num_rows+16]=0x060c00; // .. .##.....##......
    font_data[i*num_rows+17]=0x0c1800; // .. ##.....##.......
    font_data[i*num_rows+18]=0x0c1800; // .. ##.....##.......
    font_data[i*num_rows+19]=0x183000; // .# #.....##........
    font_data[i*num_rows+20]=0x187000; // .# #....###........
    font_data[i*num_rows+21]=0x3fe000; // ## #######.........
    font_data[i*num_rows+22]=0x3fc000; // ## ######..........
   }
  }
