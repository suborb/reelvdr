...
private:
  char logoDir[255];
  std::vector <std::string> logoDirList;
...
public:
  ...
  std::string GetLogoPath(const std::string& channelName, const std::string& ext=".png"); // look through list of directories and return the first found path
