...
//	AddSuspEdit (tr("Suspend behaviour"),         m_NewSetup.SuspendMode);
	...
	Add(new cMenuEditBoolItem(tr("Start ReelBox-to-ReelBox Server"),   &m_NewSetup.StartVTPServer));
	Add(new cMenuEditIntItem (tr("ReelBox-to-ReelBox Server Port"),    &m_NewSetup.VTPServerPort, 0, 65535));
