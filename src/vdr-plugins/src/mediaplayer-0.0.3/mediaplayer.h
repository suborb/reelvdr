...
#ifndef P__MEDIAPLAYER_H
#define P__MEDIAPLAYER_H
...
class cPluginMediaPlayer : public cPlugin
{
public:
    cPluginMediaPlayer();
    virtual ~cPluginMediaPlayer();

    /*override*/ const char *Version();
    /*override*/ const char *Description();
    /*override*/ bool Initialize();
    /*override*/ const char *MainMenuEntry(void) { return tr("Media Player"); }
...
private:
    ...
    cPluginMediaPlayer(const cPluginMediaPlayer &plugin);
    cPluginMediaPlayer &operator=(const cPluginMediaPlayer &plugin);
};
