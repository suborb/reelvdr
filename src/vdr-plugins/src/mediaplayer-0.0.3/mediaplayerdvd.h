...
#ifndef P__MEDIAPLAYERDVD_H
#define P__MEDIAPLAYERDVD_H

#include <string>
#include <vdr/plugin.h>
#include <vdr/status.h>

static const char *DESCRIPTION = "MediaplayerDvd";

class cPluginMediaPlayerDvd : public cPlugin
{
public:
    cPluginMediaPlayerDvd();
    virtual ~cPluginMediaPlayerDvd();

    /*override*/ const char *Version();
    /*override*/ const char *Description();
    /*override*/ bool Initialize();
    /*override*/ const char *MainMenuEntry(void) { return tr("MediaplayerDvd"); }
...
private:
    ...
    cPluginMediaPlayerDvd(const cPluginMediaPlayerDvd &plugin);
    cPluginMediaPlayerDvd &operator=(const cPluginMediaPlayerDvd &plugin);

    void OpenDvd();
};

#endif // P__MEDIAPLAYERDVD_H
