...
{
public:
    cMenuBrowserItem(cMenuFileBrowserBase* Menu): menu(Menu), isMarked(false), isFlagged(false) {}
...
{
public:
    cMenuBrowserEditStrItem(cMenuFileBrowserBase* menu,const char *Name, char *Value, int Length, const char *Allowed);
