...
public:
    ...
    virtual eOSState ShowFileWithXine(const cPlayListItem &item, bool asPlaylist = false){ return osContinue; }
    virtual eOSState ShowDvdWithXine(const cPlayListItem &item, bool asPlaylist = false){ return osContinue; }
    virtual eOSState ShowThumbnail(cPlayListItem item, bool hide, bool currentChanged){ return osContinue;}
