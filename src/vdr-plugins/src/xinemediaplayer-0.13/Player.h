...
enum ePlayModes { pmPlay, pmPause, pmSlow, pmFast, pmStill };
    ...
    enum eBackEnd { eXineBackEnd, eGstreamerBackend, eExternalBackend};
    ...
    public:
        ...
        /* override */ double FramesPerSecond(void);
...
//DL    float duration;
    ...
    int BackEnd() const
    {
        static bool isIce = cPluginManager::GetPlugin("reelice");
        
        if (isIce)
        return eExternalBackend;//eGstreamerBackend;
        //else
        return eXineBackEnd;
...
//DL        int PlayAsPesPackets(uchar* Data, int len, uint64_t pts, float& duration);
    ...
    inline std::string Player::GetAudioLangCode() const
    {
        ...
        case eExternalBackend: {
            return extLib_.AudioLang(extLib_.AudioStream());
        } // case
        break;
    ...
    inline bool Player::GetReplayMode(bool &Play, bool &Forward, int &Speed)
    {
        ...
        case eExternalBackend:
            return extLib_.GetReplayMode(Play, Forward, Speed);
    }// switch
    return false;
#endif
    }
    ...
    inline double Player::FramesPerSecond(void) { 
#ifndef USE_PLAYPES
        switch (BackEnd()) {
            case eExternalBackend:
                return extLib_.FramesPerSecond();
        } // switch
#endif
    ...
    inline bool Player::GetIndex(int &Current, int &Total, bool SnapToFrame)
    {
        ...
        case eExternalBackend:
            x = extLib_.GetIndex(Current, Total);
            break;
        } // switch
    ...
    inline uint32_t Player::HasVideo()
    {
        ...
        case eExternalBackend:
            return extLib_.VideoStreamCount() > 0;
        } //switch
#endif
        return 0;
    }
    ...
    inline uint32_t Player::HasAudio()
    {
        ...
        case eExternalBackend:
            return extLib_.AudioStreamCount() > 0;
    ...
    inline uint32_t Player::IgnoreVideo()
    {
        ...
        case eGstreamerBackend:
            ...
            return 0;
        case eExternalBackend:
            printf("%s ext not implemented yet\n", __PRETTY_FUNCTION__);
            return 0;
    ...
    inline uint32_t Player::MaxAudioChannel()
    {
        ...
        case eExternalBackend:
            return extLib_.AudioStreamCount();
    ...
    inline uint32_t Player::DvdChapterNumber()
    {
        ...
        case eExternalBackend:
            return extLib_.DVDChapterNumber();
    ...
    inline uint32_t Player::DvdChapterCount()
    {
        ...
        case eExternalBackend:
            return extLib_.DVDChapterCount();
