...
#endif
public:
  cMenuMyEditTimer(cTimer *Timer, bool New, const cEvent* Event, const cChannel* forcechannel=NULL, bool *timerCreated = NULL);
#if REELVDR
  cMenuMyEditTimer(cSwitchTimer *SwitchTimer, bool New);
#endif
