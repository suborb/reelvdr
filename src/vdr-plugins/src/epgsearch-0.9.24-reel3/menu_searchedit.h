...
protected:
  ...
  enum menu_modes { simple_mode, expert_mode };
  enum menu_modes menu_mode;
#if REELVDR
  bool openSearchTimerMenu; /* open search timer list menu after saving
                               search timer ? */
#endif

public:
  cMenuEditSearchExt(cSearchExt *SearchExt, bool New = false, bool Template = false, bool openSearchTimerMenu_=false);
