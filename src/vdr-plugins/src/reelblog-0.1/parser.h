/*
 * parser.h: This reelblog plugin is a special version of the RSS Reader Plugin (Version 1.0.2) for the Video Disk Recorder (VDR).
 *
...
#ifndef __REELBLOG_PARSER_H
#define __REELBLOG_PARSER_H
