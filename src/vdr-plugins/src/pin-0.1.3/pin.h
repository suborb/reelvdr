 ...
 * #28    0.1.5a   07.01.06,  chnage: pin in setup dialog now hidden again.
 * #27    0.1.5    06.01.06,  bugfix: Fixed protection leak when replaying via 
                                      the 'Play' key, reported by Christian Reiser.
                              change: Edit of timers fsk setting only when unlocked
                                      or timer 'not' already locked
 ...
 * ---------------------------------------------------------------------
 *
 * - hide protected plugins   (suggested by pat)
 * - hide protected recodings (suggested by hollywood)
...
static const char *VERSION        = "0.1.5a";
static const char *DESCRIPTION    = trNOOP("Childlock plugin");
static const char *MAINMENUENTRY  = trNOOP("Parental Control");
...
class cPinPlugin : public cPlugin, public PinService
{
  public:
      ...
      bool Service(const char *Id, void *Data); // Sets and UnSets OneTimeScriptAuth
