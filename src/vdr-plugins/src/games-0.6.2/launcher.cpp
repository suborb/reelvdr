...
MENUSTART(Game, menu)
MENUENTRY((char*)"Tetris",      tetris)
MENUENTRY((char*)"Tron",        tron)
MENUENTRY((char*)"Snake",       snake)
MENUENTRY((char*)"TicTacToe",   tictactoe)
MENUENTRY((char*)"Minesweeper", minesweeper)
MENUEND()
