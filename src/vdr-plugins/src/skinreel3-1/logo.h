/*
 * logo.h: 'ReelNG' skin for the Video Disk Recorder
 *
 * See the README file for copyright information and how to reach the author.
 *
 */

#ifndef __SKINREEL_LOGO_H
#define __SKINREEL_LOGO_H
...
public:
  cReelLogoCache(unsigned int cacheSizeP);
  ~cReelLogoCache();
...
extern cReelLogoCache ReelLogoCache;

#endif // __SKINREEL_LOGO_H
