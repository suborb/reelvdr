...
// START I18N - automatically generated by po2i18n.pl
  ...
  { "  Show symbols in messages",
    ...
    "",
    "  Mostra simboli nei messaggi",
    "  Symbolen bij berichten",
    "",
    "  dans les messages",
    "",
  ...
  { "  Show symbols in replay",
    ...
    "",
    "  Mostra simboli in riproduzione",
    "  Symbolen bij weergave",
    "",
    "  dans lecture",
    "",
  ...
  { "Default Fixed Size Font",
    ...
    "",
    "Carattere dimensione fissa pred.",
  ...
  { "Show channel logos",
    ...
    "Näytä kanavalogot",
    "Pokazuj logo kana³u",
    "Mostrar los logos de los canales",
    "",
    "Visa kanallogotyper",
    "",
    "",
  ...
  { "Show event/recording images",
    ...
    "",
    "Mostra immagini evento/registrazione",
    "EPG/opnamedetails tonen",
    "",
  ...
  { "Show info area in main menu",
    ...
    "",
    "Mostra area info nel menu principale",
    "Info in hoofdmenu",
    "",
  ...
  { "Show marker in lists",
    ...
    "",
    "Mostra indicatore negli elenchi",
  ...
  { "Show recording's size",
    ...
    "",
    "Mostra dimensione delle registrazioni",
    "Opnamegrootte tonen",
    "",
