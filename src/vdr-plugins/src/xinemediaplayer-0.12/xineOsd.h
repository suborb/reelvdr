...
namespace Reel{
    ...
    namespace XineMediaplayer{
        ...
        enum { NO_PLUGIN=0, FILEBROWSER_PLUGIN, SHOUTCAST_PLUGIN, IPOD_PLUGIN, MMFILES_PLUGIN, YOUTUBE_PLUGIN};
        ...
        class cXineOsd : public cOsdMenu
        {
            ...
            public:
                ...
                void        CallExt_Plugin();    //call External plugin: filebrowser/shoutcast
